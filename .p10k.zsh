# Generated by Powerlevel10k configuration wizard on 2023-08-26 at 03:35 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique # default
  # typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_last # only show last
